...
Sou formado em **Ciência da Computação** pela Universidade Federal de Ouro Preto (UFOP) e possuo mais de 10 anos de experiência em infraestrutura de TI. Atualmente, atuo como **Site Reliability Engineer (SRE)** e **Observability Engineer**, garantindo a alta disponibilidade, escalabilidade e eficiência operacional de sistemas críticos e plataformas de alta escala, incluindo operações robustas no setor de seguros.

Minha missão é equilibrar confiabilidade e velocidade de entrega técnica, utilizando dados para estabilizar ambientes, otimizar recursos e automatizar processos.
...
Acredito que a tecnologia só gera impacto através das pessoas. Por isso, divido meus estudos entre excelência técnica e desenvolvimento humano:
* **Hard Skills:** Ecossistemas AWS, OpenTelemetry, arquiteturas distribuídas e laboratórios de infraestrutura e redes de containers.
* **Soft Skills:** Inteligência Emocional, Comunicação Não Violenta (CNV), Comunicação Assertiva, Mindset, Gestão de Processos e a Arte de Falar.
